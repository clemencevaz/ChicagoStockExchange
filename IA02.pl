...
newMarche(T, [NewM,_,T,J1,NewJ2], 2):-
	...
	traiterMarchandise(Choix, M1, M2, MG, MV).
...
%Renvoie la marchandise gardée (MG) et la marchandise vendue (MV) selon le choix de l'utilisateur
traiterMarchandise(1, M1, M2, M1, M2).
traiterMarchandise(2, M1, M2, M2, M1).
